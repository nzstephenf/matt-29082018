 ...
 * Intermission Screen
 */
var layout_id, countdownInt, social_id = "default", appData = {}, activeLayout = {},
    socialData = {}, videoPlayer = document.getElementById("video-source"),
    storedSupportersOverlayData = localStorage.getItem("supporters-overlay"),
    storedCountdownData = localStorage.getItem("countdown"),
    storedBrbData = localStorage.getItem("brb"),
    storedStartingSoonData = localStorage.getItem("starting-soon"),
    storedStreamEndingData = localStorage.getItem("stream-ending");
    
var supportersOverlay = (storedSupportersOverlayData) ? JSON.parse(storedSupportersOverlayData) : {},
    countdown = (storedCountdownData) ? JSON.parse(storedCountdownData) : {},
    screen__brb = (storedBrbData) ? JSON.parse(storedBrbData) : {},
    screen__startingsoon = (storedStartingSoonData) ? JSON.parse(storedStartingSoonData) : {},
    screen__streamending = (storedStreamEndingData) ? JSON.parse(storedStreamEndingData) : {}; 
...
$(function(){
    ...
    function getAppDataLayouts(){
        ...
        if(supportersOverlay["state"] === true) $("#supporter-counter").addClass("active");
    ...
    function setupShell(){
        ...
        $("[data-current-counter]").text(supportersOverlay["current"] + "TEST");
        $("[data-total-counter]").text(supportersOverlay["goal"]);
        UpdateSupporterGoalProgressBar();

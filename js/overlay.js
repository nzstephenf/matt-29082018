...
$(function(){
        ...
        if(activeNotice["notice"] !== null){
            $.get({
                ...
                success: function(rep){
                    ...
                    var noticeStylingFile = $("#notice-block link[data-notice-href]"), noticeScriptFile = $("#notice-block script[data-notice-src]");

                    if(noticeStylingFile) $("#notice-block link[data-notice-href]").attr("href", $("#notice-block").attr("data-notice-href")+"?v="+ dateVersion);
                    if(noticeScriptFile) $("#notice-block script[data-notice-src]").attr("src", $("#notice-block").attr("data-notice-src")+"?v="+ dateVersion);
    ...
    function Themeification(){
        ...
        $("#supporter-goal-bg").css("background-image", "linear-gradient(to top left, black, "+ activeOverlay["info_bar_odd"] +")");
